...
class UV_Encoder(nn.Module):
    ...
    def __init__(self, features, embed_dim, features_num, history_uv_lists, history_r_lists, aggregator, cuda="cpu", uv=True):
        ...
        self.device = cuda
        self.linear1 = nn.Linear(self.features_num+self.embed_dim, self.embed_dim)  #
